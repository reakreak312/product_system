...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-12 mx-auto tm-login-col">
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row mt-2">
              <div class="col-12">
                <form action="php/checkuser.php" method="post" class="tm-login-form">
    ...
    <!-- <footer class="tm-footer row tm-mt-small" style="bottom:0;">
      <div class="col-12 font-weight-light">
        <p class="text-center text-white mb-0 px-4 small">
          Copyright &copy; <b>2020</b> All rights reserved. 
          <a rel="nofollow noopener" href="https://facebook.com/reakreakms" class="tm-footer-link">Created By</a>
        </p>
      </div>
    </footer> -->
